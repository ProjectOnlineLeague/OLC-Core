...
BOOST_AUTO_TEST_CASE(netbase_networks)
{
    ...
    BOOST_CHECK(CNetAddr("2501::8888").GetNetwork()                             == NET_IPV6);
...
BOOST_AUTO_TEST_CASE(netbase_properties)
{
    ...
    BOOST_CHECK(CNetAddr("2501:0DB8::").IsRFC3849());
    BOOST_CHECK(CNetAddr("169.254.1.1").IsRFC3927());
    BOOST_CHECK(CNetAddr("2502::1").IsRFC3964());
    BOOST_CHECK(CNetAddr("FC00::").IsRFC4193());
    BOOST_CHECK(CNetAddr("2501::2").IsRFC4380());
    BOOST_CHECK(CNetAddr("2501:10::").IsRFC4843());
    ...
    BOOST_CHECK(CNetAddr("2501::1").IsRoutable());
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:20001", "127.0.0.1", 2501));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:20001", "127.0.0.1", 2501));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:20001", "::ffff:127.0.0.1", 2501));
    BOOST_CHECK(TestSplitHost("[::]:20001", "::", 2501));
