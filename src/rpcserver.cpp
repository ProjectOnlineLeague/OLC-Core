...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OLC features */
        {"olc", "masternode", &masternode, true, true, false},
        {"olc", "masternodelist", &masternodelist, true, true, false},
        {"olc", "mnbudget", &mnbudget, true, true, false},
        {"olc", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"olc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"olc", "mnsync", &mnsync, true, true, false},
        {"olc", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use olcd, or the -server option to olc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> olc-cli " + methodname + " " + args + "\n";
}
