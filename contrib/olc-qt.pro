...
RESOURCES += src/qt/olc.qrc src/qt/olc_locale.qrc

TRANSLATIONS += src/qt/locale/olc_bg.ts \
                src/qt/locale/olc_de.ts \
                src/qt/locale/olc_en.ts \
                src/qt/locale/olc_es.ts \
                src/qt/locale/olc_fi.ts \
                src/qt/locale/olc_fr.ts \
                src/qt/locale/olc_it.ts \
                src/qt/locale/olc_ja.ts \
                src/qt/locale/olc_pl.ts \
                src/qt/locale/olc_pt.ts \
                src/qt/locale/olc_ru.ts \
                src/qt/locale/olc_sk.ts \
                src/qt/locale/olc_sv.ts \
                src/qt/locale/olc_vi.ts \
                src/qt/locale/olc_zh_CN.ts \
                src/qt/locale/olc_zh_TW.ts
