...
#if defined(NDEBUG)
#error "OLC cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "OLC Signed Message:\n";
...
} 	else if (nHeight > 2 && nHeight <= 10080) {
	    nSubsidy = 0.125 * COIN;
} 	else if (nHeight > 10081 && nHeight <= 20160) {
        nSubsidy = 0.25 * COIN;
} 	else if (nHeight > 20161 && nHeight <= 30240) {
        nSubsidy = 0.5 * COIN;
} 	else if (nHeight > 30241 && nHeight <= 40320) {
        nSubsidy = 1 * COIN;
} 	else if (nHeight > 40321 && nHeight <= 50400) {
        nSubsidy = 0.5 * COIN;
} 	else if (nHeight > 50401 && nHeight <= 60480) {
        nSubsidy = 0.25 * COIN;
} 	else if (nHeight > 60481 && nHeight <= 70560) {
        nSubsidy = 0.125 * COIN;
} 	else if (nHeight > 70561 && nHeight <= 80640) {
        nSubsidy = 0.25 * COIN;
} 	else if (nHeight > 80641 && nHeight <= 90720) {
        nSubsidy = 0.5 * COIN;
} 	else if (nHeight > 90721 && nHeight <= 100800) {
        nSubsidy = 1 * COIN;
} 	else if (nHeight > 100801 && nHeight <= 1108800) {
        nSubsidy = 0.5 * COIN;
} 	else if (nHeight > 1108801 && nHeight <= 120960) {
        nSubsidy = 0.25 * COIN;
} 	else if (nHeight > 483841 && nHeight <= 524160) {
        nSubsidy = 0.125 * COIN;
} 	else if (nHeight > 524161 && nHeight <= 564480) {
        nSubsidy = 0.25 * COIN;
} 	else if (nHeight > 564481 && nHeight <= 604800) {
        nSubsidy = 1 * COIN;
} 	else if (nHeight > 604801 && nHeight <= 645120) {
        nSubsidy = 0.5 * COIN;
} 	else if (nHeight > 645121 && nHeight <= 2056320) {
        nSubsidy = 0.25 * COIN;
} 	else if (nHeight > 2056321 && nHeight <= 2177280) {
        nSubsidy = 0.125 * COIN;
} 	else if (nHeight > 2177281 && nHeight <= 2298240) {
        nSubsidy = 0.0625 * COIN;
} 	else if (nHeight > 2298241 && nHeight <= 2419200) {
        nSubsidy = 0.03125 * COIN;
} 	else if (nHeight > 2419201 && nHeight <= 2540160) {
        nSubsidy = 0.04 * COIN;
} 	else if (nHeight > 2540161 && nHeight <= 2661120) {
        nSubsidy = 0.02 * COIN;
} 	else if (nHeight > 2661121 && nHeight <= 2782080) {
        nSubsidy = 0.005 * COIN;
} 	else if (nHeight > 2782081 && nHeight <= 2903040) {
        nSubsidy = 0.0025 * COIN;
} 	else if (nHeight > 2903041 && nHeight <= 302400) {
        nSubsidy = 0.00125 * COIN;
} 	else if (nHeight > 302401 && nHeight <= 3144960) {
        nSubsidy = 0.000625 * COIN;
} 	else if (nHeight > 3144961) {
        nSubsidy = 0.0003125 * COIN;
} 
return nSubsidy;
}
