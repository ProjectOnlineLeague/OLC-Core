                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("OLC-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OLC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and olc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OLC Core"), this);
    aboutAction->setStatusTip(tr("Show information about OLC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OLC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OLC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OLC addresses"));
    ...
    openAction->setStatusTip(tr("Open a OLC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OLC Core help message to get a list with possible OLC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OLC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OLC network", "", count));
}
...
{
    QString strTitle = tr("OLC Core"); // default title
